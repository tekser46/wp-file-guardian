...
define( 'WPFG_VERSION', '3.0.0' );
define( 'WPFG_DB_VERSION', '3.0.0' );
...
function wpfg_init() {
    ...
    // v3: These must run on ALL requests (not just admin).
    WPFG_Hardening::init();
    WPFG_Firewall::init();
    WPFG_Two_Factor::init();
